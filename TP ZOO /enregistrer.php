...
$reql = "INSERT INTO users VALUES ('$m','$a','$b','$c')";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="enregistrer.css">

    <style>
        /* CSS SPÉCIFIQUE POUR LA PAGE DE CONFIRMATION */
...
<body>
    ...
    <div class="confirmation-container">
        <?php if ($success): ?>
            ...
            <div class="user-info">
                <strong>Identifiant :</strong> <?php echo htmlspecialchars($a); ?>
            </div>
            ...
            <a href="index.php" class="btn-retour">Se Connecter</a>
        ...
        <?php else: ?>
            ...
            <h1 style="color: #c0392b;">Erreur d'inscription</h1>

            <p>Désolé, une erreur s'est produite lors de la création de votre compte.</p>
    ...
    <!-- Optionnel : Fond animé (même principe que les autres pages) -->
